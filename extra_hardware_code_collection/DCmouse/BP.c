...
interrupt [TIM2_OVF] void timer2_ovf_isr(void)
{
   ...
   if(error>0)r_overflow=MOTOR_DELAY+(error/4);//+(error-error0)/8;
   else if(error<0)l_overflow=MOTOR_DELAY-(error/4);//+(error-error0)/8; 
//   
...
while (1)
      {
       //Place your code here
//      if(center>90 && left <15)
//        turnLeft();
//       else 
//      if(center>90 && right <15)
//        turnRight();
//        else
      if(center>90)
        turnRight();
